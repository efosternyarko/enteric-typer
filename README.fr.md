...
| `--amrnet_palette` | `C` | Palette de couleurs pour les cartes thermiques AMR (fig6/fig7). `A` RdBu-inv · `B` RdYlBu-inv · `C` Spectral-inv · `D` Coolwarm · `E` Custom-skip-pale · `F` Blue-teal-red |
